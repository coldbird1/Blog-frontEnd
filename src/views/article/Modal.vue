    ...
    >
      ...
      <div class="head-content">
        ...
        <div class="category">
          ...
          <n-select v-model:value="selectedValue" filterable placeholder="请选择文章分类" :options="options" />
        </div>
      </div>
...
<script setup lang="ts">
  ...
  const props = withDefaults(defineProps<{ show?: boolean; status?: string | number; currentRow?: any }>(), {
    show: false,
    status: '1',
    currentRow: {}
  })
